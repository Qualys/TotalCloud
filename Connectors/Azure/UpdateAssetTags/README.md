# Update Asset Tags in Bulk for Azure Subscription Connector

A Python script leveraging Qualys public APIs to efficiently update tags for existing detached Azure Subscription connectors in bulk.
...
```bash
cd Connectors/Azure/UpdateAssetTags
```
...
5. Run the script:
```python
python azure_update_asset_tags.py
```
